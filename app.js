...
app.use('/secret', 
    express.static(path.join('https://code.jquery.com/jquery-3.4.1.min.js')
    ));

app.use('/secret', 
    express.static(path.join('https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js'))
    // add some others
    );
